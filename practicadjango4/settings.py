"""
Django settings for practicadjango4 project.
...
server_env = os.environ.get('practicadjango4_ENVIRON') or 'development'
...
ROOT_URLCONF = 'practicadjango4.core.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
	    BASE_DIR / 'practicadjango4/templates',
	],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'practicadjango4.core.wsgi.application'
